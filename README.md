...
## Screenshots
![Commands](Media/Commands.png "Commands")
![Comparison_UnknownsOnly](Media/Comparison_UnknownsOnly.png "Comparison (unknowns only)")
![Comparison_FlagWholeGame](Media/Comparison_FlagWholeGame.png "Comparison (whole game)")