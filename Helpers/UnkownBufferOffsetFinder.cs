...
namespace SramComparer.SoE.Helpers
{
	...
	internal static class UnkownBufferOffsetFinder
	{
		...
		public static int GetSaveSlotBufferOffset(string bufferName) => bufferName.Contains(StructDelimiter)
				...
				: (int)Marshal.OffsetOf<SaveSlot>(bufferName);
		...
		{
			Unknown4_BoyBuff = Offsets.SaveSlot.Unknown4_BoyBuff__BuffFlags, // Offset 112
			...
			Unknown7_DogBuff = Offsets.SaveSlot.Unknown7_DogBuff__BuffFlags, // Offset 177
			...
			Unknown15 = Offsets.SaveSlot.Unknown15, // Offset 515
			...
			Unknown16C = Offsets.SaveSlot.Unknown16C, // Offset 643
